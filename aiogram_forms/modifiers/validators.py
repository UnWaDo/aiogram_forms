...
class Validator(ABC):
    @abstractmethod
    def __call__(self, value: Any, form_data: dict[str, Any]) -> bool: ...


class MessageValidator(Validator):
    @abstractmethod
    def __call__(self, message: Message, form_data: dict[str, Any]) -> bool: ...
...
class TextValidator(MessageValidator):
    ...
    @abstractmethod
    def validate_text(self, text: str, form_data: dict[str, Any]) -> bool: ...
